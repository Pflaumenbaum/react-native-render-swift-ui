...
<a type="button" href="https://developer.apple.com/documentation/swiftui/lazyhstack" 
...
![button preview](@site/static/img/docs/vstack.png)
...
|------|------|----------|-------------|
|  children    |   `React.ReactNode`   |      ✓    |    The RNSwiftUI view that should be displayed inside of the LazyHStack         |
